...
INSERT INTO `phones` VALUES (1,'Redmi 4X',1,1),(2,'iPhone X',2,2),(3,'A20',3,3);
...
CREATE TABLE `users` (
  ...
  `email` char(255) NOT NULL DEFAULT 'user@email.com',
  PRIMARY KEY (`id`)
...
INSERT INTO `users` VALUES (1,'Shura','Korob','cool man',1,'test@email.com'),(3,'Vitalia','Gorn','not bad man',0,'gov@email.com'),(4,'Vovchyk','Bronk','real nigga',1,'vovn@email.com');
...
-- Dump completed on 2021-05-20  0:02:43
